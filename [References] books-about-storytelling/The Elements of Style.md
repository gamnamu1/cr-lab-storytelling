...
## <a name="page_3"></a>3CONTENTS

| |||Page|
| :- | :- | :- | -: |
|I.|Introductory||[5](#page_5)|
|II.|Elementary Rules of Usage||[7](#page_7)|
| |1\.|Form the possessive singular of nouns by adding *'s*|[7](#rule_1)|
| |2\.|In a series of three or more terms with a single conjunction, use a comma after each term except the last|[7](#rule_2)|
| |3\.|Enclose parenthetic expressions between commas|[8](#rule_3)|
| |4\.|Place a comma before a conjunction introducing a co-ordinate clause|[10](#rule_4)|
| |5\.|Do not join independent clauses by a comma|[11](#rule_5)|
| |6\.|Do not break sentences in two|[12](#rule_6)|
| |7\.|A participial phrase at the beginning of a sentence must refer to the grammatical subject|[13](#rule_7)|
|III.|Elementary Principles of Composition||[15](#page_15)|
| |8\.|Make the paragraph the unit of composition: one paragraph to each topic|[15](#rule_8)|
| |9\.|As a rule, begin each paragraph with a topic sentence; end it in conformity with the beginning|[17](#rule_9)|
| |10\.|Use the active voice|[19](#rule_10)|
| |11\.|Put statements in positive form|[21](#rule_11)|
| |12\.|Use definite, specific, concrete language|[22](#rule_12)|
| |13\.|Omit needless words|[24](#rule_13)|
| |14\.|Avoid a succession of loose sentences|[25](#rule_14)|
| |15\.|Express co-ordinate ideas in similar form|[26](#rule_15)|
| |16\.|Keep related words together|[28](#rule_16)|
| |17\.|In summaries, keep to one tense|[29](#rule_17)|
| |18\.|Place the emphatic words of a sentence at the end|[31](#rule_18)|
|IV.|A Few Matters of Form||[33](#page_33)|
|V.|Words and Expressions Commonly Misused||[36](#page_36)|
|VI.|Spelling||[48](#page_48)|
|VII.|Exercises on Chapters II and III||[50](#page_50)|
## <a name="page_5"></a>5I. INTRODUCTORY
This book aims to give in brief space the principal requirements of plain English style. It aims to lighten the task of instructor and student by concentrating attention (in Chapters [II](#page_7) and [III](#page_15)) on a few essentials, the rules of usage and principles of composition most commonly violated. In accordance with this plan it lays down three rules for the use of the comma, instead of a score or more, and one for the use of the semicolon, in the belief that these four rules provide for all the internal punctuation that is required by nineteen sentences out of twenty. Similarly, it gives in [Chapter III](#page_15) only those principles of the paragraph and the sentence which are of the widest application. The book thus covers only a small portion of the field of English style. The experience of its writer has been that once past the essentials, students profit most by individual instruction based on the problems of their own work, and that each instructor has his own body of theory, which he may prefer to that offered by any textbook.

The numbers of the sections may be used as references in correcting manuscript.

The writer's colleagues in the Department of English in Cornell University have greatly helped him in the preparation of his manuscript. Mr. George McLane Wood has kindly consented to the inclusion under [Rule 10](#rule_10) of some material from his *Suggestions to Authors*.

The following books are recommended for reference or further study: in connection with Chapters [II](#page_7) and [IV](#page_33), F. Howard Collins, *Author and Printer* (Henry Frowde); Chicago University Press, *Manual of Style*; T. L. De Vinne, *Correct Composition* (The Century Company); Horace Hart, *Rules for Compositors and Printers* (Oxford <a name="page_6"></a>6 University Press); George McLane Wood, *Extracts from the Style-Book of the Government Printing Office* (United States Geological Survey); in connection with Chapters [III](#page_15) and [V](#page_36), *The King's English* (Oxford University Press); Sir Arthur Quiller-Couch, *The Art of Writing* (Putnam), especially the chapter, Interlude on Jargon; George McLane Wood, *Suggestions to Authors* (United States Geological Survey); John Lesslie Hall, *English Usage* (Scott, Foresman and Co.); James P. Kelley, *Workmanship in Words* (Little, Brown and Co.). In these will be found full discussions of many points here briefly treated and an abundant store of illustrations to supplement those given in this book.

It is an old observation that the best writers sometimes disregard the rules of rhetoric. When they do so, however, the reader will usually find in the sentence some compensating merit, attained at the cost of the violation. Unless he is certain of doing as well, he will probably do best to follow the rules. After he has learned, by their guidance, to write plain English adequate for everyday uses, let him look, for the secrets of style, to the study of the masters of literature.
## <a name="page_7"></a>7II. ELEMENTARY RULES OF USAGE
### <a name="rule_1"></a>**1. Form the possessive singular of nouns by adding 's.**
...
### <a name="rule_2"></a>**2. In a series of three or more terms with a single conjunction, use a comma after each term except the last.**
Thus write,
...
Brown, Shipley & Co.
### <a name="page_8"></a>8<a name="rule_3"></a>**3. Enclose parenthetic expressions between commas.**
...
Other illustrations may be found in sentences quoted under Rules [4](#rule_4), [5](#rule_5), [6](#rule_6), [7](#rule_7), [16](#rule_16), and [18](#rule_18).

<a name="page_10"></a>10The writer should be careful not to set off independent clauses by commas: see under [Rule 5](#rule_5).
### <a name="rule_4"></a>**4. Place a comma before a conjunction introducing a co-ordinate clause.**
...
### <a name="rule_5"></a>**5. Do not join independent clauses by a comma.**
...
<a name="page_12"></a>12Stevenson's romances are entertaining. They are full of exciting adventures.

It is nearly half past five. We cannot reach town before dark.

If a conjunction is inserted the proper mark is a comma ([Rule 4](#rule_4)).
...
### <a name="rule_6"></a>**6. Do not break sentences in two.**
In other words, do not use periods for commas.

<a name="page_13"></a>13I met them on a Cunard liner several years ago. Coming home from Liverpool to New York.
...
Rules [3](#rule_3), [4](#rule_4), [5](#rule_5), and [6](#rule_6) cover the most important principles in the punctuation of ordinary sentences; they should be so thoroughly mastered that their application becomes second nature.
### <a name="rule_7"></a>**7. A participial phrase at the beginning of a sentence must refer to the grammatical subject.**
...
| - | - |
|<a name="page_14"></a>14A soldier of proved valor, they entrusted him with the defence of the city.|A soldier of proved valor, he was entrusted with the defence of the city.|
...
## <a name="page_15"></a>15III. ELEMENTARY PRINCIPLES OF COMPOSITION
### <a name="rule_8"></a>**8. Make the paragraph the unit of composition: one paragraph to each topic.**
...
<a name="page_16"></a>16F. Wherein characteristic of the writer.
...
### <a name="page_17"></a>17<a name="rule_9"></a>**9. As a rule, begin each paragraph with a topic sentence, end it in conformity with the beginning.**
...
<a name="page_19"></a>19In narration and description the paragraph sometimes begins with a concise, comprehensive statement serving to hold together the details that follow.
...
### <a name="rule_10"></a>**10. Use the active voice.**
...
<a name="page_20"></a>20The dramatists of the Restoration are little esteemed to-day.
...
The habitual use of the active voice makes for forcible writing. This is true not only in narrative principally concerned with action, but in writing of any kind. Many a tame sentence of description or exposition can be made lively and emphatic by substituting a verb in the active <a name="page_21"></a>21 voice for some such perfunctory expression as *there is*, or *could be heard*.
...
### <a name="rule_11"></a>**11. Put statements in positive form.**
...
<a name="page_22"></a>22The antithesis of negative and positive is strong:
...
### <a name="rule_12"></a>**12. Use definite, specific, concrete language.**
...
<a name="page_23"></a>23These words call up pictures. Recall how in *The Bishop Orders his Tomb in St. Praxed's Church* “the Renaissance spirit—its worldliness, inconsistency, pride, hypocrisy, ignorance of itself, love of art, of luxury, of good Latin,” to quote Ruskin's comment on the poem, is made manifest in specific details and in concrete terms.
...
| - | - |
### <a name="rule_13"></a>**13. Omit needless words.**
...
See also under [*case*](#case), [*character*](#character), [*nature*](#nature), [*system*](#system) in [Chapter V](#page_36).
...
<a name="page_25"></a>25As positive statement is more concise than negative, and the active voice more concise than the passive, many of the examples given under Rules [11](#rule_11) and [12](#rule_12) illustrate this rule as well.
...
### <a name="rule_14"></a>**14. Avoid a succession of loose sentences:**
This rule refers especially to loose sentences of a particular type, those consisting of two co-ordinate clauses, the second introduced by a conjunction or relative. Although single sentences of this type may be unexceptionable (see under [Rule 4](#rule_4)), a series soon becomes monotonous and tedious.

An unskilful writer will sometimes construct a whole paragraph of sentences of this kind, using as connectives *and*, *but*, *so*, and less frequently, *who*, *which*, *when*, *where*, and *while*, these last in non-restrictive senses (see under [Rule 3](#rule_3)).

<a name="page_26"></a>26The third concert of the subscription series was given last evening, and a large audience was in attendance. Mr. Edward Appleton was the soloist, and the Boston Symphony Orchestra furnished the instrumental music. The former showed himself to be an artist of the first rank, while the latter proved itself fully deserving of its high reputation. The interest aroused by the series has been very gratifying to the Committee, and it is planned to give a similar series annually hereafter. The fourth concert will be given on Tuesday, May 10, when an equally attractive programme will be presented.

Apart from its triteness and emptiness, the paragraph above is weak because of the structure of its sentences, with their mechanical symmetry and sing-song. Contrast with them the sentences in the paragraphs quoted under [Rule 9](#rule_9), or in any piece of good English prose, as the preface (Before the Curtain) to *Vanity Fair*.
...
### <a name="rule_15"></a>**15. Express co-ordinate ideas in similar form.**
...
See also the third example under [Rule 12](#rule_12) and the last under [Rule 13](#rule_13).

It may be asked, what if a writer needs to express a very large number of similar ideas, say twenty? Must he write <a name="page_28"></a>28 twenty consecutive sentences of the same pattern? On closer examination he will probably find that the difficulty is imaginary, that his twenty ideas can be classified in groups, and that he need apply the principle only within each group. Otherwise he had best avoid difficulty by putting his statements in the form of a table.
### <a name="rule_16"></a>**16. Keep related words together.**
...
|<a name="page_29"></a>29This is a portrait of Benjamin Harrison, grandson of William Henry Harrison, who became President in 1889.|This is a portrait of Benjamin Harrison, grandson of William Henry Harrison. He became President in 1889.|
...
### <a name="rule_17"></a>**17. In summaries, keep to one tense.**
In summarizing the action of a drama, the writer should always use the present tense. In summarizing a poem, story, or novel, he should preferably use the present, though he may use the past if he prefers. If the summary <a name="page_30"></a>30 is in the present tense, antecedent action should be expressed by the perfect; if in the past, by the past perfect.
...
Apart from the exceptions noted, whichever tense the writer chooses, he should use throughout. Shifting from one tense to the other gives the appearance of uncertainty and irresolution (compare [Rule 15](#rule_15)).
...
In notebooks, in newspapers, in handbooks of literature, summaries of one kind or another may be indispensable, and for children in primary schools it is a useful exercise to retell a story in their own words. But in the criticism or interpretation of literature the writer should be careful to avoid dropping into summary. He may find it necessary to devote one or two sentences to indicating the subject, or the opening situation, of the work he is discussing; he may cite numerous details to illustrate its qualities. But he should aim to write an orderly discussion supported by evidence, not a summary with occasional comment. <a name="page_31"></a>31 Similarly, if the scope of his discussion includes a number of works, he will as a rule do better not to take them up singly in chronological order, but to aim from the beginning at establishing general conclusions.
### <a name="rule_18"></a>**18. Place the emphatic words of a sentence at the end.**
...
<a name="page_32"></a>32A subject coming first in its sentence may be emphatic, but hardly by its position alone. In the sentence,
...
## <a name="page_33"></a>33IV. A FEW MATTERS OF FORM
...
<a name="page_34"></a>34I recall the maxim of La Rochefoucauld, “Gratitude is a lively sense of benefits to come.”
...
**Syllabication.** If there is room at the end of a line for one or more syllables of a word, but not for the whole word, divide the word, unless this involves cutting off only a <a name="page_35"></a>35 single letter, or cutting off only two letters of a long word. No hard and fast rule for all words can be laid down. The principles most frequently applicable are:
...
**As to whether.** *Whether* is sufficient; see under [Rule 13](#rule_13).

**Bid.** Takes the infinitive without *to*. The past tense in the sense, “ordered,” is *bade*.

<a name="but"></a>**But.** Unnecessary after *doubt* and *help*.

|I have no doubt but that|I have no doubt that|
| - | - |
|He could not help see but that|He could not help seeing that|

<a name="page_37"></a>37The too frequent use of *but* as a conjunction leads to the fault discussed under [Rule 14](#rule_14). A loose sentence formed with *but* can always be converted into a periodic sentence formed with *although*, as illustrated under [Rule 4](#rule_4).
...
<a name="case"></a>**Case.** The *Concise Oxford Dictionary* begins its definition of this word: “instance of a thing's occurring; usual state of affairs.” In these two senses, the word is usually unnecessary.
...
<a name="character"></a>**Character.** Often simply redundant, used from a mere habit of wordiness.

|Acts of a hostile character|Hostile acts|
| - | - |

**Claim, vb.** With object-noun, means *lay claim to*. May be used with a dependent clause if this sense is clearly involved: “He claimed that he was the sole surviving <a name="page_38"></a>38 heir.” (But even here, “claimed to be” would be better.) Not to be used as a substitute for *declare*, *maintain*, or *charge*.
...
<a name="page_39"></a>39**Effect.** As noun, means *result*; as verb, means *to bring about*, *accomplish* (not to be confused with *affect*, which means “to influence”).
...
On the formula *the fact that*, see under [Rule 13](#rule_13).
...
**He is a man who.** A common type of redundant expression; see [Rule 13](#rule_13).
...
<a name="page_41"></a>41<a name="kind_of"></a>**Kind of.** Not to be used as a substitute for *rather* (before adjectives and verbs), or except in familiar style, for *something like* (before nouns). Restrict it to its literal sense: “Amber is a kind of fossil resin;” “I dislike that kind of notoriety.” The same holds true of *sort of*.
...
<a name="nature"></a>**Nature.** Often simply redundant, used like [*character*](#character).
...
| - | - |
|<a name="page_44"></a>44There was great dissatisfaction with the decision of the arbitrators being favorable to the company.|There was great dissatisfaction that the arbitrators should have decided in favor of the company.|
...
**Should.** See under [**Would**](#would).

<a name="page_45"></a>45**So.** Avoid, in writing, the use of *so* as an intensifier: “so good;” “so warm;” “so delightful.”

On the use of *so* to introduce clauses, see [Rule 4](#rule_4).

**Sort of.** See under [**Kind of**](#kind_of).
...
<a name="system"></a>**System.** Frequently used without need.
...
<a name="page_47"></a>47shows why the use of *while* is incorrect.
...
<a name="would"></a>**Would.** A conditional statement in the first person requires *should*, not *would*.
...
| - | - |
## <a name="page_48"></a>48VI. SPELLING
...
## <a name="page_50"></a>50VII. EXERCISES ON CHAPTERS II AND III
### **I. Punctuate:**
...
### <a name="page_51"></a>51**III. Explain and correct the errors in punctuation:**
...
<a name="page_52"></a>5218. In this connection a great deal of historic fact is introduced into the novel about the past history of the cathedral and of Spain.
...
<a name="tn-bottom"></a>**Transcriber's Note:**
...
[Page 39](#page_39):\
**Effect.** As noun, means *result*; as verb, means t*o* *bring*\
